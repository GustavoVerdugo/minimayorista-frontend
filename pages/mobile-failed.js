...
import MobileFailedCheck from '../src/components/MobileFailedCheck'
import MobilePayments from '../src/components/MobilePayments'
import Navbar from '../src/components/Navbar'
import ProductsList from '../src/components/ProductsList'
import ResultPayments from '../src/components/ResultPayments'
import useFetch from '../src/helpers/useFetch'
import styles from '../styles/Home.module.css'

export default function MobileFailed() {
  return (
